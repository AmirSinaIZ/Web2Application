...
public class SplashActivity extends AppCompatActivity {
	...
	private LinearLayout loading_ui;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		loading_ui = findViewById(R.id.loading_ui);
		...
		animation.addListener(new Animator.AnimatorListener() {
			...
			public void onAnimationEnd(Animator _param1) {
				if (showINTRO.getString("show", "").equals("false")) {
					timer = new TimerTask() {
						@Override
						public void run() {
	...
	private void initializeLogic() {
		_AVLd("BallPulseIndicator");
		_ICC(logo, "#FF1763B3", "#FF1763B3");
		...
		animation.setDuration((int)(1500));
		animation.start();
	}
	...
	public void _AVLd(final String _key) {
		...
		loading_ui.addView(v);
		
		v.setIndicatorColor(Color.parseColor("#FF1763B3"));
